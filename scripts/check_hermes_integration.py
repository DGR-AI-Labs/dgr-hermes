...
""")
        ...
        loaded = manager._plugins["dgr_hermes"]
        ...
        result = json.loads(registry.dispatch(names[0], {"text": "Hello world"}, scope=manager.scope_key))
        assert result["result"] == {"characters": 11, "words": 2, "lines": 1}, result
        result = json.loads(registry.dispatch(names[1], {"text": "Hello hello world"}, scope=manager.scope_key))
        ...
        print("PASS: actual Hermes entry-point load, both module dispatches, unload and disabled reload")
